...
public class GeminiService {
    ...
    public GeminiService(@Value("${google.gemini.api.key}") String apiKey, NaverApiService naverApiService) {
    ...
    public String summarizeKeyword(String keyword) {
        NaverNewsResponseDto naverNewsResponseDto = naverApiService.searchNewsByKeyword(keyword);
