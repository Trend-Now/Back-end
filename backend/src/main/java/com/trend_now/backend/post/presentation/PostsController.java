...
public class PostsController {
    ...
    public ResponseEntity<ApiResponse<PostInfoResponseDto>> findPostById(
        ...
        PostInfoResponseDto postInfoResponseDto = postsService.findPostsById(boardId, postId,
            authentication);
    ...
    public ResponseEntity<CheckPostCooldownResponse> checkPostCooldown(
        ...
        return ResponseEntity.status(HttpStatus.OK)
            .body(postsService.checkPostCooldown(boardId, authentication.getPrincipal()));
    }
}